...
ros::Publisher pub_denm_; //@todo -- remove 

void decode_received_denm() {
    int sockfd;
    ...
    while(ros::ok() == true){
        ...
        if(received_bytes > 150){ // === @todo: is this check necessary? -- this was added in cpm receiver to receive only valid data
            ...
            if (gossip_type == GossipType_FacilityLayerReception) {
                ...
                }else if(union_msg == FacilityLayerMessage_DENM){
                    std::cout << "Received a DENM " << std::endl;
...
int main(int argc, char** argv)
{
    ...
    ros::init(argc, argv, "denm_receive_node");
